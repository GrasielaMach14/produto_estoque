    ...
    @csrf
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="tipo_movimentacao" id="tipo_movimentacao" value="Entrada" checked>
                <label class="form-check-label" for="tipo_movimentacao">
                    Entrada
                </label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="tipo_movimentacao" id="tipo_movimentacao" value="Saída">
                <label class="form-check-label" for="tipo_movimentacao">
                    Saída
                </label>
            </div>
        ...
        <div class="form-group">
            <div class="col-md-4">
                ...
                <input type="number" name="valor_total" class="form-control" id="valor_total" step="0.01" min="0.01">
            </div>
        </div>            
